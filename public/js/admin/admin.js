...
window.addEventListener('DOMContentLoaded', async ()=>{
    ...
    // earning
        document.getElementById("earning_in_lifetime").innerText =  members.earning?members.earning: 0 + '.00₹';
        document.getElementById("earning_in_this_month").innerText = members.earning? members.earning: 0 + '.00₹';
